...
|发贴|post|POST|user_id、title、content、star_id、imgs|post_id|-|
|发评论|post/{post_id}|POST|post_id、user_id、title、content、star_id、imgs|post_id|-|
|给帖子点赞|post/{post_id}/like|PUT|post_id、user_id|state|-|
|给帖子取消点赞|post/{post_id}/unlike|PUT|post_id、user_id|state|-|
